/**
 * Generator script for experiments.js
 * Writes the complete 65-experiment configuration file
 */
const fs = require('fs');
const path = require('path');

const TARGET = path.join(__dirname, 'experiments.js');
...
// ============================================================
// CHAPTER 1: 图像处理基础 (6 experiments)
// ============================================================
add(`
  /* ============================
   * 第1章 图像处理基础 (6个实验)
...
console.log('Complete! All 65 experiments written to experiments.js');
